package com.bridgelabz.adminmodule.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.adminmodule.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("adminmodule",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("adminmodule", "http://bridgelabz.adminmodule", "swasthikkj@gmail.com"),
                "Apache 2.0",
